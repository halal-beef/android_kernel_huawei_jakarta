...
#define NUMBER_SSID_PER_LINE 16
	...
	scanlog_dbg(LOG_SCAN_DONE_D2K, TRACE, "Total:%u/%u; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s\n",
	...
	for (u4Index = 1; u4Index < u4ResultNum; u4Index++) {
		...
		scanlog_dbg(LOG_SCAN_DONE_D2K, TRACE, "%s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s; %s\n",
