...
#if defined(LCDKIT_MTK_COMMON_PANEL)
	&lcdkit_mtk_common_panel,
#endif
...
#if defined(ILI9881C_HD_DSI_VDO)
	&ili9881c_hd_dsi_vdo_lcm_drv,
#endif
#if defined(HLT_HX8394F_HD_DSI_VDO)
	&hlt_hx8394f_hd_dsi_vdo_lcm_drv,
#endif
