...
sub create_hisi_lcd_config_data
{
    ...
    $lcd_config .= "        pinfo->aod_enter_cmds.cmds_set = ".lc($lcd_name)."_aod_enter_cmds;\n";
    $lcd_config .= "        pinfo->aod_enter_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_aod_enter_cmds);\n";
    $lcd_config .= "        pinfo->aod_exit_cmds.cmds_set = ".lc($lcd_name)."_aod_exit_cmds;\n";
    $lcd_config .= "        pinfo->aod_exit_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_aod_exit_cmds);\n";
    $lcd_config .= "        pinfo->aod_high_brightness_cmds.cmds_set = ".lc($lcd_name)."_aod_high_brightness_cmds;\n";
    $lcd_config .= "        pinfo->aod_high_brightness_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_aod_high_brightness_cmds);\n";
    $lcd_config .= "        pinfo->aod_low_brightness_cmds.cmds_set = ".lc($lcd_name)."_aod_low_brightness_cmds;\n";
    $lcd_config .= "        pinfo->aod_low_brightness_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_aod_low_brightness_cmds);\n";
    $lcd_config .= "        pinfo->command2_enter_cmds.cmds_set = ".lc($lcd_name)."_command2_enter_cmds;\n";
    $lcd_config .= "        pinfo->command2_enter_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_command2_enter_cmds);\n";
    $lcd_config .= "        pinfo->command2_exit_cmds.cmds_set = ".lc($lcd_name)."_command2_exit_cmds;\n";
    $lcd_config .= "        pinfo->command2_exit_cmds.cmd_cnt  = ARRAY_SIZE(".lc($lcd_name)."_command2_exit_cmds);\n";
