...
#endif
#ifdef CONFIG_HUAWEI_BLK_FLUSH_REDUCE
static struct queue_sysfs_entry queue_huawei_apd_tst_entry = {
	.attr = {.name = "huawei_queue_tst_apd", .mode = 0200 },
	.show = NULL,
	.store = huawei_queue_apd_tst_enable_store,
};
#endif
...
#endif
#ifdef CONFIG_HUAWEI_BLK_FLUSH_REDUCE
	&queue_huawei_apd_tst_entry.attr,
#endif
...
#ifdef CONFIG_HUAWEI_BLK_FLUSH_REDUCE
	huawei_blk_queue_register(q, disk);
#endif
	/*
